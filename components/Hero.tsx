...
export default function Hero() {
  const devzora = (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="text-link-text-green hover:underline transition"
    >
      DevZora
    </a>
  )
  ...
  return (
    <div className="min-h-[100vh] pt-20 w-full bg-primary-grey flex items-center justify-center px-4 font-heading">
      ...
      >
        ...
        <p
          className="text-sm md:text-base text-text-grey leading-relaxed"
        >
        ...
        <div
          className="flex justify-center gap-4 flex-wrap pt-4 uppercase"
        >
          <Link
            href="/catalog"
          ...
          <Link
            href="/login"
            className="px-6 py-2.5 bg-button-yellow text-button-text-black rounded-full shadow-md hover:bg-primary-dark-grey transition"
          >
            Librarian Login
          </Link>
        </div>
        ...
        <p
          className="text-sm text-text-grey pt-4"
        >
          Are you a member of PMSA Library?{' '}
          <Link
            href="/member-login"
            className="text-link-text-green hover:underline font-medium"
          >
            Login here
          </Link>
        </p>
        ...
        <div
          className="pt-4 text-xs text-text-grey"
        >
