...
export default function BooksHomePage() {
  ...
  return (
    <div className="pt-32 min-h-screen bg-primary-grey px-4 pb-10">
      <h1 className="text-3xl font-extrabold mb-8 text-heading-text-black font-heading uppercase">Book Management</h1>

      <div className="space-y-5 uppercase font-heading text-heading-text-black">
        <Link
          href="books/add"
        ...
        >
          <span className="rotate-180 tracking-wide font-semibold uppercase">Update Book</span>
        </button>
      </div>
